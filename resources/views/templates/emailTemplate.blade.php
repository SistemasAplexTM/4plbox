                        ...
                        <table id="tbl-emailTemplate" class="table table-striped table-hover table-bordered" style="width: 100%;">
                            ...
                            <tfoot>
    							...
    							<div role="tabpanel" class="tab-pane fade" id="variables">
                                  ...
                                  <a class="btn btn-default copy-btn btn-xs" data-toggle="tooltip" title="Copiar" @click.stop.prevent="copyTestingCode('{num_guia}')">
                                    Copy
                                  </a>
                                </li>
    												    <li class="list-group-item">{num_warehouse}
                                  <a class="btn btn-default copy-btn btn-xs" data-toggle="tooltip" title="Copiar" @click.stop.prevent="copyTestingCode('{num_warehouse}')">
                                    Copy
                                  </a>
                                </li>
    												    <li class="list-group-item">{flete_impuesto}
                                  <a class="btn btn-default copy-btn btn-xs" data-toggle="tooltip" title="Copiar" @click.stop.prevent="copyTestingCode('{flete_impuesto}')">
                                    Copy
                                  </a>
                                </li>
    												    <li class="list-group-item">{piezas}
                                  <a class="btn btn-default copy-btn btn-xs" data-toggle="tooltip" title="Copiar" @click.stop.prevent="copyTestingCode('{piezas}')">
                                    Copy
                                  </a>
                                </li>
    												    <li class="list-group-item">{seguro}
                                  <a class="btn btn-default copy-btn btn-xs" data-toggle="tooltip" title="Copiar" @click.stop.prevent="copyTestingCode('{seguro}')">
                                    Copy
                                  </a>
                                </li>
    												    <li class="list-group-item">{descuento}
                                  <a class="btn btn-default copy-btn btn-xs" data-toggle="tooltip" title="Copiar" @click.stop.prevent="copyTestingCode('{descuento}')">
                                    Copy
                                  </a>
                                </li>
    												    <li class="list-group-item">{cargos_add}
                                  <a class="btn btn-default copy-btn btn-xs" data-toggle="tooltip" title="Copiar" @click.stop.prevent="copyTestingCode('{cargos_add}')">
                                    Copy
                                  </a>
                                </li>
    												    <li class="list-group-item">{total}
                                  <a class="btn btn-default copy-btn btn-xs" data-toggle="tooltip" title="Copiar" @click.stop.prevent="copyTestingCode('{total}')">
                                    Copy
                                  </a>
                                </li>
    												  </ul>
                                  ...
                                  <a class="btn btn-default copy-btn btn-xs" data-toggle="tooltip" title="Copiar" @click.stop.prevent="copyTestingCode('{nom_shipper}')">
                                    Copy
                                  </a>
                                </li>
    												  </ul>
                                  ...
                                  <a class="btn btn-default copy-btn btn-xs" data-toggle="tooltip" title="Copiar" @click.stop.prevent="copyTestingCode('{nom_consignee}')">
                                    Copy
                                  </a>
                                </li>
    												    <li class="list-group-item">{dir_consignee}
                                  <a class="btn btn-default copy-btn btn-xs" data-toggle="tooltip" title="Copiar" @click.stop.prevent="copyTestingCode('{dir_consignee}')">
                                    Copy
                                  </a>
                                </li>
    												    <li class="list-group-item">{dir2_consignee}
                                  <a class="btn btn-default copy-btn btn-xs" data-toggle="tooltip" title="Copiar" @click.stop.prevent="copyTestingCode('{dir2_consignee}')">
                                    Copy
                                  </a>
                                </li>
    												    <li class="list-group-item">{ciu_consignee}
                                  <a class="btn btn-default copy-btn btn-xs" data-toggle="tooltip" title="Copiar" @click.stop.prevent="copyTestingCode('{ciu_consignee}')">
                                    Copy
                                  </a>
                                </li>
    												    <li class="list-group-item">{depto_consignee}
                                  <a class="btn btn-default copy-btn btn-xs" data-toggle="tooltip" title="Copiar" @click.stop.prevent="copyTestingCode('{depto_consignee}')">
                                    Copy
                                  </a>
                                </li>
    												    <li class="list-group-item">{zip_consignee}
                                  <a class="btn btn-default copy-btn btn-xs" data-toggle="tooltip" title="Copiar" @click.stop.prevent="copyTestingCode('{zip_consignee}')">
                                    Copy
                                  </a>
                                </li>
    												    <li class="list-group-item">{pais_consignee}
                                  <a class="btn btn-default copy-btn btn-xs" data-toggle="tooltip" title="Copiar" @click.stop.prevent="copyTestingCode('{pais_consignee}')">
                                    Copy
                                  </a>
                                </li>
    												    <li class="list-group-item">{pass_consignee}
                                  <a class="btn btn-default copy-btn btn-xs" data-toggle="tooltip" title="Copiar" @click.stop.prevent="copyTestingCode('{pass_consignee}')">
                                    Copy
                                  </a>
                                </li>
    												    <li class="list-group-item">{email_consignee}
                                  <a class="btn btn-default copy-btn btn-xs" data-toggle="tooltip" title="Copiar" @click.stop.prevent="copyTestingCode('{email_consignee}')">
                                    Copy
                                  </a>
                                </li>
    												    <li class="list-group-item">{tel_consignee}
                                  <a class="btn btn-default copy-btn btn-xs" data-toggle="tooltip" title="Copiar" @click.stop.prevent="copyTestingCode('{tel_consignee}')">
                                    Copy
                                  </a>
                                </li>
    												    <li class="list-group-item">{zip_consignee}
                                  ...
                                  <a class="btn btn-default copy-btn btn-xs" data-toggle="tooltip" title="Copiar" @click.stop.prevent="copyTestingCode('{cel_consignee}')">
                                    Copy
                                  </a>
                                </li>
    												  </ul>
                                  ...
                                  <a class="btn btn-default copy-btn btn-xs" data-toggle="tooltip" title="Copiar" @click.stop.prevent="copyTestingCode('{id_agencia}')">
                                    Copy
                                  </a>
                                </li>
    												    <li class="list-group-item">{logo_agencia}
                                  <a class="btn btn-default copy-btn btn-xs" data-toggle="tooltip" title="Copiar" @click.stop.prevent="copyTestingCode('{logo_agencia}')">
                                    Copy
                                  </a>
                                </li>
    												    <li class="list-group-item">{nom_agencia}
                                  <a class="btn btn-default copy-btn btn-xs" data-toggle="tooltip" title="Copiar" @click.stop.prevent="copyTestingCode('{nom_agencia}')">
                                    Copy
                                  </a>
                                </li>
    												    <li class="list-group-item">{tel_agencia}
                                  <a class="btn btn-default copy-btn btn-xs" data-toggle="tooltip" title="Copiar" @click.stop.prevent="copyTestingCode('{tel_agencia}')">
                                    Copy
                                  </a>
                                </li>
    												    <li class="list-group-item">{email_agencia}
                                  <a class="btn btn-default copy-btn btn-xs" data-toggle="tooltip" title="Copiar" @click.stop.prevent="copyTestingCode('{email_agencia}')">
                                    Copy
                                  </a>
                                </li>
    												    <li class="list-group-item">{dir_agencia}
                                  <a class="btn btn-default copy-btn btn-xs" data-toggle="tooltip" title="Copiar" @click.stop.prevent="copyTestingCode('{dir_agencia}')">
                                    Copy
                                  </a>
                                </li>
    												    <li class="list-group-item">{zip_agencia}
                                  <a class="btn btn-default copy-btn btn-xs" data-toggle="tooltip" title="Copiar" @click.stop.prevent="copyTestingCode('{zip_agencia}')">
                                    Copy
                                  </a>
                                </li>
    												    <li class="list-group-item">{ciudad_agencia}
                                  <a class="btn btn-default copy-btn btn-xs" data-toggle="tooltip" title="Copiar" @click.stop.prevent="copyTestingCode('{ciudad_agencia}')">
                                    Copy
                                  </a>
                                </li>
    												    <li class="list-group-item">{estado_agencia}
                                  <a class="btn btn-default copy-btn btn-xs" data-toggle="tooltip" title="Copiar" @click.stop.prevent="copyTestingCode('{estado_agencia}')">
                                    Copy
                                  </a>
                                </li>
    												    <li class="list-group-item">{url_principal}
                                  <a class="btn btn-default copy-btn btn-xs" data-toggle="tooltip" title="Copiar" @click.stop.prevent="copyTestingCode('{url}')">
                                    Copy
                                  </a>
                                </li>
    												    <li class="list-group-item">{url_terms}
                                  <a class="btn btn-default copy-btn btn-xs" data-toggle="tooltip" title="Copiar" @click.stop.prevent="copyTestingCode('{url_terms}')">
                                    Copy
                                  </a>
                                </li>
    												    <li class="list-group-item">{url_casillero}
                                  <a class="btn btn-default copy-btn btn-xs" data-toggle="tooltip" title="Copiar" @click.stop.prevent="copyTestingCode('{url_casillero}')">
                                    Copy
                                  </a>
                                </li>
    												    <li class="list-group-item">{url_registro}
                                  <a class="btn btn-default copy-btn btn-xs" data-toggle="tooltip" title="Copiar" @click.stop.prevent="copyTestingCode('{url_registro}')">
                                    Copy
                                  </a>
                                </li>
    												    <li class="list-group-item">{url_rastreo}
                                  <a class="btn btn-default copy-btn btn-xs" data-toggle="tooltip" title="Copiar" @click.stop.prevent="copyTestingCode('{url_rastreo}')">
                                    Copy
                                  </a>
                                </li>
    												    <li class="list-group-item">{url_prealerta}
                                  <a class="btn btn-default copy-btn btn-xs" data-toggle="tooltip" title="Copiar" @click.stop.prevent="copyTestingCode('{url_prealerta}')">
                                    Copy
                                  </a>
                                </li>
    												    <li class="list-group-item">{url_registro_casillero}
                                  <a class="btn btn-default copy-btn btn-xs" data-toggle="tooltip" title="Copiar" @click.stop.prevent="copyTestingCode('{url_registro_casillero}')">
                                    Copy
                                  </a>
                                </li>
    												  </ul>
                                  ...
                                  <a class="btn btn-default copy-btn btn-xs" data-toggle="tooltip" title="Copiar" @click.stop.prevent="copyTestingCode('{datos_detalle}')">
                                    Copy
                                  </a>
                                </li>
    												    <li class="list-group-item">{tracking}
                                  <a class="btn btn-default copy-btn btn-xs" data-toggle="tooltip" title="Copiar" @click.stop.prevent="copyTestingCode('{tracking}')">
                                    Copy
                                  </a>
                                </li>
    												  </ul>
