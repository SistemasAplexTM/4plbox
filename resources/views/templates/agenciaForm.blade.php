                        ...
                        <div role="tabpanel" class="tab-pane fade in active" id="tab1" style="margin-top: 20px;">
                            ...
                            <div class="col-lg-4">
                                        ...
                                        <div class="form-group {{ $errors->has('descripcion') ? ' has-error' : '' }}">
                                            <div class="col-lg-4">
                                                <label for="descripcion"
                                                    class="control-label">@lang('general.name')</label>
                                            </div>
                                            <div class="col-lg-8">
                                        ...
                                        <div class="form-group {{ $errors->has('responsable') ? ' has-error' : '' }}">
                                            <div class="col-lg-4">
                                                <label for="responsable"
                                                    class="control-label">@lang('general.responsable')</label>
                                            </div>
                                            <div class="col-lg-8">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group {{ $errors->has('direccion') ? ' has-error' : '' }}">
                                            <div class="col-lg-4">
                                                <label for="direccion"
                                                    class="control-label">@lang('general.address')</label>
                                            </div>
                                            <div class="col-lg-8">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group {{ $errors->has('telefono') ? ' has-error' : '' }}">
                                            <div class="col-lg-4">
                                                <label for="telefono"
                                                    class="control-label">@lang('general.phone')</label>
                                            </div>
                                            <div class="col-lg-8">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group {{ $errors->has('whatsapp') ? ' has-error' : '' }}">
                                            <div class="col-lg-4">
                                                <label for="whatsapp"
                                                    class="control-label">@lang('general.whatsapp')</label>
                                            </div>
                                            <div class="col-lg-8">
                                                <input type="tel" class="form-control" data-mask="(999) 999-9999"
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div
                                            class="form-group {{ $errors->has('localizacion_id') ? ' has-error' : '' }}">
                                            <div class="col-sm-4">
                                                <label for="localizacion_id"
                                                    class="control-label gcore-label-top">@lang('general.city')</label>
                                            </div>
                                            <div class="col-sm-8">
                                                ...
                                                <small
                                                    class="help-block">{{ $errors->first('localizacion_id') }}</small>
                                                @endif
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group {{ $errors->has('email_cc') ? ' has-error' : '' }}">
                                            <div class="col-lg-4">
                                                <label for="email_cc"
                                                    class="control-label">@lang('general.email_cc')</label>
                                            </div>
                                            <div class="col-lg-8">
                                        ...
                                        <div class="form-group">
                                            <div class="col-lg-4">
                                                <label for="prefijo_pobox" class="control-label">
                                                    <div class="col-sm-12" data-trigger="hover" data-container="body"
                                                        data-toggle="popover" data-placement="rigth"
                                                        ...
                                                        <i class="fal fa-question-circle"
                                                            style="cursor: pointer; color: coral;"></i>
                                                    </div>
                                                </label>
                                            </div>
                                            <div class="col-lg-8">
                                                <input type="text" class="form-control" id="prefijo_pobox"
                                                    name="prefijo_pobox"
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group {{ $errors->has('url_terms') ? ' has-error' : '' }}">
                                            <div class="col-lg-4">
                                                <label for="url_terms"
                                                    class="control-label">@lang('general.url_terms')</label>
                                            </div>
                                            <div class="col-lg-8">
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-2">
                                        <div class="form-group" id="classTarifaP">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" readonly="" class="form-control" id="tarifaP"
                                                    name="tarifaP" placeholder="0">
                                            </div>
                                            <small id="msn1" class="help-block"></small>
                                        </div>
                                    </div>
                                    <div class="col-sm-2">
                                        <div class="form-group" id="classTarifaP">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-addon">$</span>
                                                <input type="text" readonly="" class="form-control" id="seguroP"
                                                    name="seguroP" placeholder="0">
                                            </div>
                                            <small id="msn1" class="help-block"></small>
                                        </div>
                                    </div>
                                    <div class="col-sm-2">
                                        <div class="form-group" id="classTarifaP">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-addon">$</span>
                                                <input type="text" readonly="" class="form-control" id="min" name="min"
                                                    placeholder="0">
                                            </div>
                                            <small id="msn1" class="help-block"></small>
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-2">
                                        <div class="form-group" id="classTarifaA">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-addon">$</span>
                                                <input type="text" class="form-control" id="tarifaA" name="tarifaA"
                                                    placeholder="Ej: 0.1">
                                            </div>
                                            <small id="msn1" class="help-block"></small>
                                        </div>
                                    </div>
                                    <div class="col-sm-2" data-container="body" data-toggle="popover"
                                        data-placement="top"
                                        ...
                                        <div class="form-group" id="classSeguro">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-addon">$</span>
                                                <input type="text" class="form-control" id="seguro" name="seg"
                                                    value="0">
                                            </div>
                                            <small id="msn1" class="help-block"></small>
                                        </div>
                                    ...
                                    <div class="col-sm-2">
                                        <div class="form-group" id="classSeguro">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-addon">$</span>
                                                <input type="text" class="form-control" id="min_agency"
                                                    name="min_agency" value="0">
                                            </div>
                                            <small id="msn1" class="help-block"></small>
                                        </div>
                                    </div>
                                    <div class="col-sm-1">
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-12">
                                                <a class="btn btn-primary btn-sm" type="button" id="btn_add_row"
                                                    onclick="addRow()" value="1" data-toggle="tooltip"
                                                    title="Agregar"><i class="fal fa-plus"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="table-responsive form-group">
                                        ...
                                        <table class="table table-striped table-bordered table-hover"
                                            ...
                                            <tbody>
                                                ...
                                                <tr id="fila{{ $count }}" class="rowServices">
                                                    <td><input type="hidden" id="servi" name=""
                                                            value="{{ $data->servicios_id }}" class="form-control"
                                                            readonly><input type="text" id="serviN" name=""
                                                            value="{{ $data->tipo_embarque }} - {{ $data->servicio }}"
                                                            class="form-control" readonly></td>
                                                    <td><input type="text" id="tariP" name=""
                                                            value="{{ $data->tarifa_principal }}" class="form-control"
                                                            readonly></td>
                                                    <td><input type="text" id="tariPmin" name=""
                                                            value="{{ $data->tarifa_minima }}" class="form-control"
                                                            readonly></td>
                                                    <td><input type="text" id="segup" name=""
                                                            value="{{ $data->seguro_principal }}" class="form-control"
                                                            readonly></td>
                                                    <td><input type="text" id="tariA{{ $data->id }}" name=""
                                                            value="{{ $data->tarifa_agencia }}" class="form-control"
                                                            readonly></td>
                                                    <td><input type="text" id="segu{{ $data->id }}" name=""
                                                            value="{{ $data->seguro }}" class="form-control" readonly>
                                                    </td>
                                                    <td><input type="text" id="min{{ $data->id }}" name=""
                                                            value="{{ $data->tarifa_minima_agencia }}"
                                                            class="form-control" readonly></td>

                                                    <td>
                                                        <a onclick="editRowServices({{ $count }}, {{ $data->id }})"
                                                            id="btn_edit{{ $data->id }}" class='btn_edit edit_btn'
                                                            data-toggle='tooltip' data-placement='top' title='Editar'><i
                                                                class='fal fa-pencil fa-lg'></i></a>
                                                        <a class="delete_btn btn_remove"
                                                            onclick="removeRowServices({{ $count }}, {{ $data->id }})"
                                                            id="{{ $data->id }}"><i class="fal fa-trash-alt fa-lg"
                                        ...
                                        <div id="noEnviar" class="col-lg-12"
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <agency-integrations-component
                                        :agency_id="{{ ((isset($agencia) and $agencia) ? $agencia->id : 0) }}">
                                    </agency-integrations-component>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12" style="margin-top: 10px;">
                                    <div class="col-lg-6">
                                        <h3>Públicas</h3>
                                        <div class="form-group">
                                            <table class="table table-striped table-hover table-bordered" id="tbl-url"
                                                style="width: 100%;">
                                                <thead>
                                                    <tr>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td><a target="_blank"
                                                                href="{{ url('/').'/rastreo' }}">{{ url('/').'/rastreo' }}</a>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                        ...
                                        <table class="table table-striped table-hover table-bordered" id="tbl-url"
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="editable_url" data-name="url_registro_casillero"
                                                            data-type="textarea"
                                                ...
                                                <tr>
                                                    <td>Prealertar</td>
                                                    <td>
                                                        <a class="editable_url" data-name="url_prealerta"
                                                            data-type="textarea"
