                        ...
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                ...
                                <div class="ibox-tools">
                                    ...
                                    <input type='checkbox' data-toggle="toggle" id='show-totales' name="liquidar" @click="showTotals()" data-size='mini' data-on="Si" data-off="No" data-width="50" data-style="ios" data-onstyle="primary" data-offstyle="danger" {{ ($documento->liquidado != 0 || env('APP_LIQUIDADO') == 1 ) ? 'checked="checked"' : '' }}>
