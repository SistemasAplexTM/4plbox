                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <a class="btn btn-primary" data-toggle="tooltip" title="Agregar" @click="addPartie" v-if="!edit_p"><i class="fa fa-plus"></i> Agregar</a>
                                            <a class="btn btn-warning" data-toggle="tooltip" title="Editar" @click="editPartie" v-else="edit_p"><i class="fa fa-edit"></i> Editar</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
