...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
    	...
    	@foreach ($detalle as $value)
            ...
            <?php $contRegistros++ ?>
	        <table border="0" cellpadding="0" cellspacing="0" height="288" width="216">
	            <tr>
	                <td colspan="4" style="text-align:center">
	                    <img src="{{ asset('storage/') }}/{{ ((isset($documento->agencia_logo) and $documento->agencia_logo != '') ? trim($documento->agencia_logo) : 'logo.png') }}"  style="height: 80px;page-break-after:{{ ($contRegistros === $piezas) ? 'avoid' : 'always' }}"/>
	                </td>
	            </tr>
	            <tr>
